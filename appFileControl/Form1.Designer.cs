namespace appFileControl
{
  partial class Form1
  {
    ...
    protected override void Dispose(bool disposing)
    {
      ...
      base.Dispose(disposing);
		...
		private void InitializeComponent()
		{
			...
			btnSaveTextFile.Location = new Point(1050, 136);
			...
			// btnSave_document
			// 
			btnSave_document.Font = new Font("Segoe UI", 20F);
			btnSave_document.Location = new Point(515, 136);
			btnSave_document.Name = "btnSave_document";
			btnSave_document.Size = new Size(253, 71);
			btnSave_document.TabIndex = 7;
			btnSave_document.Text = "Create and Save";
			btnSave_document.UseVisualStyleBackColor = true;
			btnSave_document.Click += btnSave_document_Click;
			// 
			// Form1
			// 
    ...
    private Button btnSaveTextFile;
		private Button btnSave_document;
	}
}
